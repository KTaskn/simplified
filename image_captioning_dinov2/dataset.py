"""PyTorch Dataset for COCO images + STAIR/Snow Japanese captions (DINOv2 version)."""
...
class CachedCaptionDataset(Dataset):
    """Dataset using pre-cached DINOv2 features instead of raw images.

    Expects a cache file (dict: image_id -> tensor(num_patches, embed_dim) in float16)
    ...
    def __init__(
        ...
        # Load cached DINOv2 features into memory
    ...
    def __getitem__(self, idx):
        ...
        # Retrieve cached DINOv2 features (float16 -> float32)
